...
import { getBoards,getUserProfile, createBoard, editBoard, getUser, createTask, getTasksForBoard,editTask } from '../../../api/api';  
import {
                            ...
                            {task.assignees && task.assignees.length > 0 ? (
                              task.assignees.map((assignee) => {
                                ...
                                if (user) {
                                  ...
                                  return (
                                    <span key={assignee} className="badge bg-primary me-2" style={{borderRadius: "50%", padding: "10px"}}>
                ...
                <div key={user._id} className="d-flex align-items-center mb-2">
                  <div className="position-relative">
                    <CAvatar
                      size="sm"
                      className="me-2"
                      style={{ backgroundColor: getRandomColor(), cursor: 'pointer',color:'white' }}
